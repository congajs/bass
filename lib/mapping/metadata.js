...
Metadata.prototype = {
    ...
    addAltData: function(name, data){
        this.altdata[name] = data
    },
    ...
    getCollectionName: function() {
        if (this.altdata.collection !== undefined) {

            if (typeof this.altdata.collection === 'function') {
                return this.altdata.collection()
            }
            return this.altdata.collection
        }
