...
module.exports = class Manager {
    ...
    /**
     * Get a slave client
     * @param {String} [name] The slave (connection name) to fetch - if not given, a random slave is returned
     * @returns {Client}
     */
    ...
    createQuery() {
        ...
        if (typeof this.definition.adapter['query'] !== 'undefined') {
            return new this.definition.adapter['query']();
        }
    ...
    /**
     * Get metadata about the structure of a collection
     *
     * @param  {String} collection
     * @return {Promise}
     */
    getMetaDataForCollectionFromDatabase(collection) {

        return new Promise((resolve, reject) => {

            this.client.getMetaDataForCollection(collection, (err, metadata) => {
