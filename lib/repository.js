...
Repository.prototype = {
	...
	getSlave: function(name) {
		...
		return this._manager.getSlave(name);
	} ,
	...
	findBy: function(criteria, sort, skip, limit){
		...
		this.getSlave().findBy(metadata, metadata.collection, dbCriteria, sort, skip, limit, function(err, data){
	...
	findWhereIn: function(field, values, sort, limit) {
		...
		if (!Array.isArray(values) || values.length === 0) {
			...
			this.getSlave().findWhereIn(metadata, field, values, sort, limit, function(err, data) {
				if (err) {
	...
	findByQuery: function(query){
		...
		this.getSlave().findByQuery(metadata, metadata.collection, dbQuery, function(err, queryResult){
	...
	findCountByQuery: function(query){
		...
		this.getSlave().findCountByQuery(metadata, metadata.collection, dbQuery, function(err, data) {
			if (err){
