...
module.exports = class Registry {
	...
	registerManagerDefinition(name, managerDefinition) {
		...
		for (name in managerDefinition.metadataRegistry.metas) {
			managerName = managerDefinition.metadataRegistry.metas[name].managerName;
			this.modelNameToManagerNameMap[name] = managerName;
			this.prototypIdToManagerNameMap[managerDefinition.metadataRegistry.metas[name].proto.prototype._BASS_PROTOTYPE_ID] = managerName;
		}
	}
