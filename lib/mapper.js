...
Mapper.prototype = {
	 ...
	 * @return {void}
	 */
	mapDataToModels: function(manager, metadata, data, cb, walk) {
	 ...
	 * @return {void}
	 */
	mergeInRelations: function(manager, metadata, data, cb) {
	 ...
	 * @return {void}
	 */
	mapDataToPartialModel: function(metadata, data, cb, walk) {
