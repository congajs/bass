...
Compiler.prototype = {
	...
	registerEventListenersOnDefinition: function(config, definition){
		...
		definition.metadataRegistry.registerEventListener('preHydrate', new DiscriminatorListener(), 'onPreHydrate', 99999);
		definition.metadataRegistry.registerEventListener('createDocument', new DiscriminatorListener(), 'onCreateDocument', 99999);
