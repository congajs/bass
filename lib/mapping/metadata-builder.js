...
MetadataBuilder.prototype = {
	...
	build: function(data){
		...
		var protoId = crypto.createHash('md5').update(data.filePath).digest("hex");
	 ...
	 * @returns {void}
	 */
	handleDefinitionAnnotations: function(metadata, annotations){
	 ...
	 * @returns {void}
	 */
	handleMethodAnnotations: function(metadata, annotations) {
